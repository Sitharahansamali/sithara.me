...
export default function CertificatesSection() {
  return (
    <section id="certificates" className="relative px-4 py-24 sm:px-6 lg:px-8">
      {/* Background Glow */}
      <div className="pointer-events-none absolute bottom-1/4 right-10 h-96 w-96 rounded-full bg-[#58a6ff]/10 blur-3xl" />
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mx-auto mb-16 max-w-3xl text-center">
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 rounded-full border border-[#34d399]/30 bg-[#34d399]/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-wider text-[#34d399]"
          >
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {certificates.map((cert, idx) => (
            <motion.article
              ...
              className="glass-panel group relative flex flex-col justify-between overflow-hidden rounded-2xl p-6 transition-all hover:-translate-y-1.5"
            >
              {/* Accent Top Bar */}
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between text-xs">
                  <span className="font-semibold text-slate-400">{cert.year}</span>
                  <span
                ...
                <div>
                  <h3 className="text-base font-bold text-white group-hover:text-[#58a6ff] transition-colors leading-snug">
                    {cert.title}
                  </h3>
              ...
              <div className="mt-6 pt-4 border-t border-white/10">
                <a
                  ...
                  className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#58a6ff] hover:text-white transition-colors"
                >
